...
__version__ = "6" #working on 6.1


# TODO LIST FOR FUTURE FEATURES:
#    - create ShapeGroup class (moves/scales/rotates together)
...
#             yPixelScale = scalingFactorY / canvas.trans.yscale
    ...
    def _draw(self, canvas, options):
        ...
        raise Exception("must override _draw in subclasses")

    def _move(self, dx, dy):
        """updates internal state of object to move it dx,dy units"""
        raise Exception("must override _move in subclasses")

    def _scale(self, scalingFactorX, scalingFactorY):
        """updates internal state of object to scale it by the given factors"""
        raise Exception("must override _scale in subclasses")
    
    def getShapeWidth(self):
        """Returns the width of the bounding box containing this graphics object"""
        #override in subclasses
        raise Exception("Sorry, this feature is not implemented yet for this type of graphics object.")
    ...
    def getCenter(self):
        ...
        raise Exception("must override getCenter in subclasses")
